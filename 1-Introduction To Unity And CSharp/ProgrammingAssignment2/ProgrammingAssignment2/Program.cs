    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            while (input[0] != 'q')
            {
                ...
                Console.WriteLine(player2_1.Rank + "," + player1_1.Suit);
                Console.WriteLine(player2_2.Rank + "," + player1_2.Suit);
                Console.WriteLine(player2_3.Rank + "," + player1_2.Suit);

                // print the cards for player 3
                Console.WriteLine(player3_1.Rank + "," + player1_1.Suit);
                Console.WriteLine(player3_2.Rank + "," + player1_2.Suit);
                Console.WriteLine(player3_3.Rank + "," + player1_2.Suit);

                // print the cards for player 4
                Console.WriteLine(player4_1.Rank + "," + player1_1.Suit);
                Console.WriteLine(player4_2.Rank + "," + player1_2.Suit);
